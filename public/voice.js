...
// Start only after an explicit visitor gesture, even with saved microphone permission.
recoveryMessage = 'Talk to M · Select the avatar to start';
status('Voice is optional. Select the avatar to start.');
refreshAvatar();
